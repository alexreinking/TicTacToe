...
# Generated by qmake (3.0) (Qt 5.0.1) on: Thu Feb 21 23:27:30 2013
# Project:  TicTacToe.pro
# Template: app
# Command: C:\Qt\Qt5.0.1\5.0.1\mingw47_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile TicTacToe.pro
#############################################################################
...
Makefile: TicTacToe.pro C:/Qt/Qt5.0.1/5.0.1/mingw47_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.0.1/5.0.1/mingw47_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile TicTacToe.pro
